...
import { StatsCards } from '@/components/features/habit/stats-cards';
import { TopRow } from '@/components/features/habit/top-row';
  ...
  return (
    <main className='min-h-screen bg-neutral-950 text-white px-4 py-8'>
      <div className='max-w-2xl mx-auto'>
        <TopRow title={habit.title} color={habit.color} />
        {habit.description && (
